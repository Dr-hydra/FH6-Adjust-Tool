Imports Shapes = System.Windows.Shapes
...
Public Class MyCard
    ...
    '属性
    Private IsSwapping As Boolean = False
    ...
    Public Shared Sub StackInstall(ByRef Stack As StackPanel, Type As Integer, Optional CardTitle As String = "")
        ...
        Dim Items As IEnumerable = TryCast(Stack.Tag, IEnumerable)
        If Items Is Nothing OrElse TypeOf Stack.Tag Is String Then Items = {Stack.Tag}
        For Each Data As Object In Items
            Stack.Children.Add(New MyListItem With {
                .Title = If(Data?.ToString(), ""),
                .Info = "",
                .Height = 42,
...
#Region "高度改变动画"
    ...
    Private Sub MySizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
        If Not UseAnimation OrElse Not IsSwapping Then Return
